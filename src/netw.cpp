...
double netw::gphyNetw() const { return phyNetw; }
double netw::gtotalNetw() const { return totalNetw; }
double netw::gutilNetw() const { return utilNetw; }
double netw::gavailNetw() const { return availNetw; }
double netw::gautilNetw() const { return autilNetw; }
int netw::gnumTasks() const { return numTasks; }
double netw::goverCommitNet() const { return overCommitNet; }
