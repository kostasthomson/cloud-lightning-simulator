...
int resource::galloc() const
{
    return alloc;
}

int resource::gactive() const
{
    return active;
}

int resource::gmovable() const
{
    return movable;
}
...
int resource::gID() const
{
    return ID;
}

double resource::gtotalProc() const
{
    return totalProc;
}

double resource::gavailProc() const
{
    return availProc;
}

double resource::gutilProc() const
{
    return utilProc;
}

double resource::gtotalMem() const
{
    return totalMem;
}

double resource::gavailMem() const
{
    return availMem;
}

double resource::gutilMem() const
{
    return utilMem;
}

double resource::gtotalSto() const
{
    return totalSto;
}

double resource::gavailSto() const
{
    return availSto;
}

double resource::gutilSto() const
{
    return utilSto;
}

double resource::gphysProc() const
{
    return physProc;
}

double resource::gphysMem() const
{
    return physMem;
}

double resource::gphysSto() const
{
    return physSto;
}

double resource::gcompCap() const
{
    return compCap;
}

int resource::gaccelerator() const
{
    return accelerator;
}

int resource::gtotAcc() const
{
    return totAcc;
}

int resource::gavailAcc() const
{
    return availAcc;
}

int resource::gutilAcc() const
{
    return utilAcc;
}

double resource::gaccCompCap() const
{
    return accCompCap;
}
...
double resource::goverCommitMem() const
{
    return overCommitMem;
}

double 	resource::gautilProc() const
{
    return autilProc;
}

double  resource::gautilMem() const
{
    return autilMem;
}

double	resource::garhoAcc() const
{
    return arhoAcc;
}

int resource::gnumOfTasks() const
{
    return numOfTasks;
}

double resource::gcCompCapPerProc() const
{
    return cCompCapPerProc;
}

double resource::gcCompCapPerAcc() const
{
    return cCompCapPerAcc;
}
